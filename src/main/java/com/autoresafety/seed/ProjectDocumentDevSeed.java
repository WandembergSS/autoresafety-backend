    ...
    void seed(@Observes StartupEvent event) {
        ...
        ProjectDocumentDto.Step4UcasDto step4 = ProjectDocumentDto.Step4UcasDto.builder()
            ...
            .hazardousConditions(List.of(
                ProjectDocumentDto.Step4UcasDto.HazardousConditionDto.builder()
                    .id(1L)
                    .ref("HC-01")
                    .description("Hazardous condition not mitigated during obstacle avoidance")
                    .context("Obstacle avoidance control loop")
                    .consequence("Increased likelihood of collision")
                    .hazardRefs(List.of("H-1"))
                    .build()
            ))
            .controllerConstraints(List.of(
                ProjectDocumentDto.Step4UcasDto.ControllerConstraintDto.builder()
                    .id(1L)
                    .sourceUcaHc("UCA-1")
                    .constraintId("CC-01")
        ...
        ProjectDocumentDto.Step5ControllerConstraintsDto step5 = ProjectDocumentDto.Step5ControllerConstraintsDto.builder()
            .constraints(List.of(
                ProjectDocumentDto.Step5ControllerConstraintsDto.ConstraintDto.builder()
                    .id(1L)
                    .ucaRef("UCA-1")
                    .constraint("Autopilot shall command evasive heading when obstacle distance is below the minimum safe-separation threshold for hazard H-1.")
                    .enforcementMechanism("Runtime safe-separation guard in the navigation control loop")
                    .status("defined")
                    .build(),
                ProjectDocumentDto.Step5ControllerConstraintsDto.ConstraintDto.builder()
                    .id(2L)
                    .ucaRef("UCA-2")
                    .constraint("Operator shall not issue Pause mission during active obstacle avoidance unless emergency override conditions are explicitly confirmed.")
                    .enforcementMechanism("Command-interlock that blocks operator pause requests while the avoidance state is active")
                    .status("defined")
                    .build(),
                ProjectDocumentDto.Step5ControllerConstraintsDto.ConstraintDto.builder()
                    .id(3L)
                    .ucaRef("UCA-3")
                    .constraint("Autopilot shall issue heading adjustments only within the validated obstacle-avoidance time window and shall suppress late commands.")
                    .enforcementMechanism("Timing monitor with stale-command rejection for heading updates")
                    .status("defined")
                    .build(),
                ProjectDocumentDto.Step5ControllerConstraintsDto.ConstraintDto.builder()
                    .id(4L)
                    .ucaRef("UCA-4")
                    .constraint("Operator shall issue Pause mission immediately when telemetry indicates imminent collision risk and autonomous avoidance is degraded.")
                    .enforcementMechanism("Operator decision checklist with collision-risk alert escalation")
                    .status("proposed")
                    .build(),
                ProjectDocumentDto.Step5ControllerConstraintsDto.ConstraintDto.builder()
                    .id(5L)
                    .ucaRef("UCA-5")
                    .constraint("Autopilot shall autonomously pause mission when localization confidence drops below the minimum threshold near obstacles.")
                    .enforcementMechanism("Localization-health watchdog that triggers autonomous mission pause")
                    .status("defined")
                    .build()
            ))
            .build();

        ProjectDocumentDto.Step5InformationDto step5Information = ProjectDocumentDto.Step5InformationDto.builder()
            .lossScenarios(List.of(
                ProjectDocumentDto.Step5InformationDto.LossScenarioDto.builder()
                    .id("LS-01")
                    .description("Delayed command causes unsafe exposure during obstacle avoidance")
                    .associatedUnsafeBehaviorIds(List.of("UCA-01"))
                    .sourceRationale("Derived from timing-related unsafe control action analysis")
                    .build(),
                ProjectDocumentDto.Step5InformationDto.LossScenarioDto.builder()
                    .id("LS-02")
                    .description("Operator receives stale feedback and issues an unsafe pause command")
                    .associatedUnsafeBehaviorIds(List.of("UCA-02"))
                    .sourceRationale(null)
                    .build()
            ))
            .safetyRequirements(List.of(
                ProjectDocumentDto.Step5InformationDto.SafetyRequirementDto.builder()
                    .id("SR-01")
                    .description("System shall reject stale-feedback-driven pause actions during active avoidance")
                    .addressedLossScenarioIds(List.of("LS-01", "LS-02"))
                    .build()
            ))
            .build();
        ...
        ProjectDocumentDto document = ProjectDocumentDto.builder()
            ...
            .step5Information(step5Information)
